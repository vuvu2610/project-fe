  ...
  return (
    <div className='w-full max-w-[1024px] md:mx-auto  py-20 gap-y-3 mt-6 mb-40 flex gap-4 justify-between items-center relative'>
      <div className='flex flex-col gap-2 flex-1'>
        ...
        <p>Bạn đã nhận được phiếu giảm giá<br /> cho đơn hàng tiếp theo</p>

        <Link to={routes.product} className='rounded-xl bg-rgb(0, 136, 84)-300 font-semibold transition-all duration-300 ease-in-out text-black p-4 w-content underline'>
          Quay về Trang chủ ➡
        </Link>
      </div>
      <div className='flex-1'>
        <CouponCard />
        <Button onClick={printPDF} className='mt-4 absolute top-0 right-0'><FaPrint size={20} /></Button>
      </div>
