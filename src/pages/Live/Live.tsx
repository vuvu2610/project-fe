    ...
    return (
        <div className="flex flex-col h-screen">
            <div className="flex flex-1 justify-around items-center p-4">
                <video ref={localVideoRef} autoPlay muted className="w-1/2 border-2 border-black rounded" />
                <video ref={remoteVideoRef} autoPlay className="w-1/2 border-2 border-black rounded" />
            </div>
            <Chat ws={ws} />
        </div>
    );
